...
rdesk.prototype.getContacts = function getContacts(params, callback) {
	...
	const options = {
		url: this.buildUrl('contacts', params),
		method: 'GET',
		json: true,
		headers: this.buildTokenHeader()
	}
...
rdesk.prototype.getContact = function getContacts(contactKey, callback) {
	const self = this;
...
rdesk.prototype.getMembers = function getMembers(callback) {
	const self = this;
...
rdesk.prototype.getOffices = function getOffices(callback) {
	const self = this;
